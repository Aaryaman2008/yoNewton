...
Engine.update(engine);
 ...
 if(keyCode === 50){
	Matter.Body.applyForce(bobObject2.body,bobObject2.body.position,{x:-600,y:1000})
}

if(keyCode === 51){
	Matter.Body.applyForce(bobObject3.body,bobObject3.body.position,{x:-7000,y:1000})
}

if(keyCode === 52){
	Matter.Body.applyForce(bobObject4.body,bobObject4.body.position,{x:600,y:1000})
}

if(keyCode === 53){
	Matter.Body.applyForce(bobObject5.body,bobObject5.body.position,{x:500,y:1000})
}
}
